# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 20:09:24 2017
...
def load_data(filename,i):
    ...
    training_data_content=file_data[0:5000]
    testing_data_content=file_data[5000:6000]
    validation_data_content=file_data[6000:7000]
    ...
    return(training_data_content,testing_data_content,validation_data_content,
           training_data_label,testing_data_label,validation_data_label)
...
f = gzip.open('../data/quickdrawreduced.pkl.gz','wb')
