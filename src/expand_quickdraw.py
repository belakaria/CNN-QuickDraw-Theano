...
Take the 50,000 training images, and create an expanded set of
...
if os.path.exists("../data/quickdraw_expanded2.pkl.gz"):
    print("The expanded training set already exists.  Exiting.")
else:
    f = gzip.open("../data/quickdrawreduced2.pkl.gz", 'rb')
    ...
    f = gzip.open("../data/quickdraw_expanded2.pkl.gz", "w")
